// Generated by gencpp from file nistcrcl/CrclCommandMsg.msg
// DO NOT EDIT!


#ifndef NISTCRCL_MESSAGE_CRCLCOMMANDMSG_H
#define NISTCRCL_MESSAGE_CRCLCOMMANDMSG_H
...
struct CrclCommandMsg_
{
  ...
  _eepercent_type eepercent;
   ...
   typedef std::vector< ::nistcrcl::CrclMaxProfileMsg_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::nistcrcl::CrclMaxProfileMsg_<ContainerAllocator> >::other >  _profile_type;
  _profile_type profile;


    enum { initCanon = 1u };
     enum { endCanon = 2u };
     enum { actuatejoints = 3u };
     enum { moveto = 4u };
     enum { dwell = 5u };
     enum { message = 6u };
     enum { moveThroughTo = 7u };
     enum { setCoordinatedMotion = 8u };
     enum { stopMotion = 9u };
     enum { setEndEffector = 10u };
     enum { openToolChange = 11u };
     enum { closeToolChanger = 12u };
     enum { drawObject = 13u };
     enum { eraseObject = 14u };
     enum { setGripperPose = 15u };
     enum { pick = 16u };
     enum { place = 17u };
 

  typedef boost::shared_ptr< ::nistcrcl::CrclCommandMsg_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::nistcrcl::CrclCommandMsg_<ContainerAllocator> const> ConstPtr;

}; // struct CrclCommandMsg_

typedef ::nistcrcl::CrclCommandMsg_<std::allocator<void> > CrclCommandMsg;

typedef boost::shared_ptr< ::nistcrcl::CrclCommandMsg > CrclCommandMsgPtr;
typedef boost::shared_ptr< ::nistcrcl::CrclCommandMsg const> CrclCommandMsgConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::nistcrcl::CrclCommandMsg_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::nistcrcl::CrclCommandMsg_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::nistcrcl::CrclCommandMsg_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::nistcrcl::CrclCommandMsg_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::nistcrcl::CrclCommandMsg_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::nistcrcl::CrclCommandMsg_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::nistcrcl::CrclCommandMsg_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::nistcrcl::CrclCommandMsg_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::nistcrcl::CrclCommandMsg_<ContainerAllocator> >
{
  static const char* value()
  {
    return "c66b4e46b129654eb64cd3b9cedc142e";
  }

  static const char* value(const ::nistcrcl::CrclCommandMsg_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xc66b4e46b129654eULL;
  static const uint64_t static_value2 = 0xb64cd3b9cedc142eULL;
};

template<class ContainerAllocator>
struct DataType< ::nistcrcl::CrclCommandMsg_<ContainerAllocator> >
{
  static const char* value()
  {
    return "nistcrcl/CrclCommandMsg";
  }
...
template<class ContainerAllocator>
struct Definition< ::nistcrcl::CrclCommandMsg_<ContainerAllocator> >
{
  static const char* value()
  {
...
\n\
================================================================================\n\
MSG: nistcrcl/CrclMaxProfileMsg\n\
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::nistcrcl::CrclCommandMsg_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::nistcrcl::CrclCommandMsg_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::nistcrcl::CrclCommandMsg_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
    ...
    for (size_t i = 0; i < v.profile.size(); ++i)
    {
      ...
      s << std::endl;
      s << indent;
      Printer< ::nistcrcl::CrclMaxProfileMsg_<ContainerAllocator> >::stream(s, indent + "    ", v.profile[i]);
    }
  }
};
...
#endif // NISTCRCL_MESSAGE_CRCLCOMMANDMSG_H
