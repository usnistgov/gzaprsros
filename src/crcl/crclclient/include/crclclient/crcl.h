...
namespace Crcl {
    ...
    ActuateJointsType::ActuateJoint_sequence  ConvertCmdJnts(sensor_msgs::JointState joints, double angleConversion);
     ...
     */
    Crcl::PoseType Convert(tf::Pose pose, double lengthConversion=1.0);
