...
extern go_result go_asines(go_real s, go_real *asp, go_real *asn);

/*! Double-valued inverse cosine, giving both solutions */
extern go_result go_acoses(go_real c, go_real *acp, go_real *acn);

/*! Double-valued inverse tangent, giving both solutions */
extern go_result go_atans(go_real t, go_real *atp, go_real *atn);
...
*/
extern go_result go_cart_cart_pose
(
...
extern go_result go_rpy_cart_mult(const go_rpy *rpy, const go_cart *in, go_cart *out);
...
extern go_result go_hom_hom_mult(const go_hom *h1, const go_hom *h2, go_hom *hout);
...
extern go_result go_pose_vel_mult(const go_pose *pose, const go_vel *vel, go_vel *out);
...
extern go_result go_mat3_inv(go_real a[3][3],
			     go_real ainv[3][3]);
extern go_result go_mat3_mat3_mult(go_real a[3][3],
				   go_real b[3][3],
				   go_real axb[3][3]);
extern go_result go_mat3_vec3_mult(go_real a[3][3],
				   go_real v[3],
				   go_real axv[3]);
...
extern go_result go_mat4_inv(go_real a[4][4],
			     go_real ainv[4][4]);
extern go_result go_mat4_mat4_mult(go_real a[4][4],
				   go_real b[4][4],
				   go_real axb[4][4]);
extern go_result go_mat4_vec4_mult(go_real a[4][4],
				   go_real v[4],
				   go_real axv[4]);
...
*/
extern go_result go_mat6_inv(go_real a[6][6],
			     go_real ainv[6][6]);
...
*/
extern go_result go_mat6_mat6_mult(go_real a[6][6],
				   go_real b[6][6],
				   go_real axb[6][6]);
...
/*!
  ...
  Returns GO_RESULT_OK.
*/
extern go_result go_mat6_vec6_mult(go_real a[6][6],
				   go_real v[6],
				   go_real axv[6]);
...
/*!
  ...
  in \a hom.
 */
extern go_result go_dh_hom_convert(const go_dh *dh, go_hom *hom);
...
*/
extern go_result go_hom_dh_convert(const go_hom *hom, go_dh *dh);
...
extern go_result go_linear_cos_sin_solve(go_real a, go_real b, go_real *th1, go_real *th2);
