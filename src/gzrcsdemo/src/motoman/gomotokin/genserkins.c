...
#include <math.h>
#include "gomotokin/gotypes.h"		/* go_result, go_integer */
#include "gomotokin/gomath.h"		/* go_pose */
#include "gomotokin/_gokin.h"		/* go_kin_type */
#include "gomotokin/genserkins.h"		/* these decls */
